...
def main():
    ...
    test_input = {
        ...
        "lat": 35.6762,
        "lon": 139.6503,
        # v4.0: 20問×5段階Likert回答。論理派タイプ寄りで「自分は冷静に話してるだけ」型を想定
        # Q1-Q4 = A論理派, Q5-Q8 = B責任型, Q9-Q12 = C安定型, Q13-Q16 = D社交型, Q17-Q20 = E共感型
        "answers": {
            # A論理派：4〜5（強く当てはまる）
            "Q1": 5, "Q2": 5, "Q3": 4, "Q4": 5,
            # B責任型：3〜4（やや当てはまる）
            ...
            # D社交型：2〜3
            "Q13": 3, "Q14": 2, "Q15": 2, "Q16": 3,
            # E共感型：1〜2（あまり当てはまらない）
            "Q17": 2, "Q18": 2, "Q19": 1, "Q20": 2,
        },
        "narrative": {
    ...
    output_path = os.path.join(
        output_dir,
        f"45歳からの信頼される男診断_{test_input['name'].replace(' ', '')}_v4.0_{datetime.now().strftime('%Y%m%d')}.pdf",
    )
